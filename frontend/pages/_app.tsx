        ...
        <div className="app-shell" style={{ display: "grid", placeItems: "center", minHeight: "100vh" }}>
          <div className="content-panel" style={{ maxWidth: "500px", textAlign: "center", padding: "40px" }}>
            ...
            <p className="lead compact-lead">
              Sistem mendeteksi kesalahan fatal saat merender komponen. 
              Ini biasanya terjadi karena konfigurasi database (Supabase) belum terisi di dashboard Cloudflare.
            </p>
            ...
            <p className="session-meta" style={{ marginTop: "24px" }}>
              Saran: Cek tab <b>Console</b> di Browser (F12) untuk informasi lebih detil.
            </p>
          </div>
        </div>
      );
